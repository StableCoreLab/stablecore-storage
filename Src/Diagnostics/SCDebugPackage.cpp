...
namespace StableCore::Storage
{
    namespace
    {
        ...
        ErrorCode WriteUtf8Buffer(SCStreamingExportContext* context,
    ...
    ErrorCode WriteExportText(SCStreamingExportContext* context,
                              const std::string& text,
                              const SCPackageSizePolicy& sizePolicy)
    {
    ...
    ErrorCode WriteExportLine(SCStreamingExportContext* context,
                              const std::string& text,
                              const SCPackageSizePolicy& sizePolicy)
    {
