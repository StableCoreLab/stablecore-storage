...
std::wstring BuildConditionSql(const QueryCondition& condition)
{
    ...
    switch (condition.op)
    {
    case QueryConditionOperator::Equal: sql << L"="; break;
    case QueryConditionOperator::NotEqual: sql << L"<>"; break;
    case QueryConditionOperator::LessThan: sql << L"<"; break;
    case QueryConditionOperator::LessThanOrEqual: sql << L"<="; break;
    case QueryConditionOperator::GreaterThan: sql << L">"; break;
    case QueryConditionOperator::GreaterThanOrEqual: sql << L">="; break;
    case QueryConditionOperator::In: sql << L"IN"; break;
    case QueryConditionOperator::Between: sql << L"BETWEEN"; break;
    case QueryConditionOperator::IsNull: sql << L"IS NULL"; break;
    case QueryConditionOperator::IsNotNull: sql << L"IS NOT NULL"; break;
    case QueryConditionOperator::StartsWith: sql << L"LIKE 'prefix%'"; break;
    case QueryConditionOperator::Contains: sql << L"LIKE '%needle%'"; break;
    case QueryConditionOperator::EndsWith: sql << L"LIKE '%suffix'"; break;
    }
    return sql.str();
}
