...
namespace StableCore::Storage
{
    ...
    {
        // First-stage query plans allow exactly one level of groups; nesting is
        // not modeled here.
    ...
    struct QueryPlan
    {
        ...
        // Multiple groups are combined using this operator; first-stage plans
        // do not model nesting.
